...
url <- 'https://arxiv.org/search/?query=%22data+science%22&searchtype=all&abstracts=show&order=-announced_date_first&size=50'
...
write.csv(papers, file = "Arxiv papers on Data Science.csv")
